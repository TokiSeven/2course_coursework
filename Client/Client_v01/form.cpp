...
void Form::send(int cmd)
{
    ...
    case 1:
        ...
        break;
    case 2:
        sendBegin(out, "NEW_ANGLE");
        sendPosition(out);
        break;
    case 3:
        sendBegin(out, "NEW_HEALTH");
        sendHealth(out);
        break;
    case 4:
        sendBegin(out, "NEW_ARMOR");
        sendArmor(out);
        break;
    }
...
void Form::sendBegin(QDataStream &out, QString command)
{
    out << qint64(0);
    out << this->pl->getName();
    out << command;
}
void Form::sendEnd(QByteArray &data, QDataStream &out)
{
    out.device()->seek(qint64(0));
    out << qint64(data.size() - sizeof(qint64));
    soc->writeDatagram(data, this->s_address, this->s_port);
}
void Form::sendPosition(QDataStream &out)
{
    out << this->pl->getX();
    out << this->pl->getY();
}
void Form::sendAngle(QDataStream &out)
{
    out << this->pl->getAngle();
}
/*void Form::sendWeapon(QDataStream &out)
{
}*/
void Form::sendHealth(QDataStream &out)
{
    out << this->pl->getHealth();
}
void Form::sendArmor(QDataStream &out)
{
    out << this->pl->getArmor();
}
/*void Form::sendFire(QDataStream &out)
{
}*/
